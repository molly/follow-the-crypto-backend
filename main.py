...
from process_company_and_individual_contributions import (
...
def main():
    ...
    diff["individual_contributions"] = update_spending_by_individuals(db)
    process_individual_contributions(db)
    # print(diff)
