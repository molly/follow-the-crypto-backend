...
This is the Python backend that processes FEC data for [Tech Influence Watch](https://influence.citationneeded.news/). For the Next.js application that powers the website, see [follow-the-crypto](https://github.com/molly/follow-the-crypto).
